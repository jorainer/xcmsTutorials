...
An illustration how chromatographic peaks within a small *m/z* range are grouped
by the *peakDensity* method is shown in the sketch below.
...
```{r features-missing-values-filled}
#' Extract the m/z-rt region for selected peaks
mz_rt <- featureArea(data, features = c("FT026", "FT028", "FT246", "FT306"))
mz_rt[, "rtmin"] <- mz_rt[, "rtmin"] - 2
mz_rt[, "rtmax"] <- mz_rt[, "rtmax"] + 2
...
- don't limit yourself to just `xcms`, use the vast of additional packages,
  methods, visualizations in R.
