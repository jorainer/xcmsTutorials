...
Louail P, Brunius C, Garcia-Aloy M, Kumler W, Storz N, Stanstrup J, Treutler H,
Vangeenderhuysen P, Witting M, Neumann S, Rainer J. xcms in Peak Form: Now
Anchoring a Complete Metabolomics Data Preprocessing and Analysis Software
Ecosystem. Anal Chem. 2025 Dec 8. doi:
...
This version of the workshop uses packages from **Bioconductor release 3.22**
(October 2025) and hence bases on Bioconductor's docker container for that
release (*RELEASE_3_22*). The required steps for installation are:
...
For manual installation, an R version >= 4.5.0 is required as well as recent
